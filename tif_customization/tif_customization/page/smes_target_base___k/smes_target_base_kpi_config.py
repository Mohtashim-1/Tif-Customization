"""KPI target base aligned with SMEs Target Base spreadsheet (3 regions)."""
...
REGION_SUMMARY = {
	"sindh": {"per_day_target_points": 6, "working_days": WORKING_DAYS_DEFAULT},
...
INCREMENT_SCALE = [
	...
	{"label": "Above 100%", "max_percent": None, "increment": "15% - 20%"},
]
...
def _t(per_day_target=0, points=0, yearly=None):
	return {"per_day_target": per_day_target, "points": points, "yearly": yearly}


def _targets(sindh, urban, rural):
	return {"sindh": sindh, "urban": urban, "rural": rural}
...
KPI_ACTIVITIES = [
	{
		...
		"metric": "visits",
		"targets": _targets(_t(2, 3), _t(2, 2), _t(2, 2)),
	},
	{
		...
		"targets": _targets(_t(1, 6, 6), _t(1, 5, 5), _t(1, 4, 4)),
	},
	{
		...
		"targets": _targets(_t(0, 8, 12), _t(0, 7, 10), _t(0, 6, 8)),
	},
	{
		"key": "meeting_ulama",
		...
		"targets": _targets(_t(1, 4), _t(1, 3), _t(1, 3)),
	},
	{
	...
	},
	{
		...
		"targets": _targets(_t(1, 6), _t(1, 5), _t(1, 4)),
	},
	{
		"key": "academic_task",
		"label": "Academic Task",
		...
		"targets": _targets(_t(0, 2), _t(0, 2), _t(0, 2)),
	},
	{
		"key": "other_official",
	...
	},
	{
		...
		"category": "Core Responsibility",
		"metric": "enrolment",
		"targets": _targets(_t(0, 5, 100), _t(0, 5, 70), _t(0, 5, 50)),
	},
	{
		"key": "co_curricular",
		...
		"targets": _targets(_t(1, 3), _t(1, 3), _t(1, 2)),
	},
	{
		...
		"targets": _targets(_t(0, 10, 50), _t(0, 10, 40), _t(0, 10, 30)),
	},
	{
		...
		"targets": _targets(_t(0, 5, 148), _t(0, 5, 100), _t(0, 5, 80)),
	},
	{
		"key": "model_school_a",
		...
		"targets": _targets(_t(0, 6), _t(0, 6), _t(0, 6)),
	},
	{
		"key": "model_school_b",
		...
		"targets": _targets(_t(0, 12), _t(0, 12), _t(0, 12)),
	},
]
