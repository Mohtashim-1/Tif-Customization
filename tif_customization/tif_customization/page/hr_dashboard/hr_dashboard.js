		...
		window.TIFAttendanceLeaveDashboard = class TIFAttendanceLeaveDashboard {
					...
					<div class="tif-attdash">
						...
						<div class="tif-attdash__cards" style="display:none">
							...
							<div class="tif-card tif-card--clickable" data-card="referred_employee_count" title="Click for detail">
								...
								<div class="tif-card__value">—</div>
								<div class="tif-card__hint">Joined on an employee reference</div>
							</div>
							<div class="tif-card tif-card--clickable" data-card="beneficiary_people_count" title="Click for detail">
								<div class="tif-card__label">Beneficiary People</div>
								<div class="tif-card__value">—</div>
			...
			inject_styles() {
				...
				style.textContent = `
					...
					.tif-card[data-card="referred_employee_count"]{--tif-card-accent:#7c3aed;--tif-card-accent-text:#6d28d9;--tif-card-muted:#4c1d95;background:linear-gradient(135deg,#f5f3ff 0%,#ede9fe 100%);border-color:#ddd6fe}
					.tif-card[data-card="beneficiary_people_count"]{--tif-card-accent:#c2410c;--tif-card-accent-text:#9a3412;--tif-card-muted:#7c2d12;background:linear-gradient(135deg,#fff7ed 0%,#ffedd5 100%);border-color:#fed7aa}
			...
			render_kpis(data) {
				...
				this.set_card_hint(
					"new_hires_this_year",
					data.fiscal_year_label || "Payroll year (26 Jun – 25 Jun)",
				);
