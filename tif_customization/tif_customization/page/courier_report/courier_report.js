...
if (typeof window.CourierDashboard === 'undefined') {
	...
	render_kpis() {
		...
		let cards = [
			...
			{ label: 'Schools', value: format_number_value(kpi_data.schools_served || 0), gradient: '#30cfd0, #330867' },
			{ label: 'Individuals', value: format_number_value(kpi_data.individuals_served || 0), gradient: '#a18cd1, #fbc2eb' },
