...
SPECIFIC_ITEM_CODES = [
	...
	"TQM6PE",
	"TQM7PE",
	"Tadress Tarjama Tul Quran-6 Class-Balouchistan Edition",
	"Tadress Tarjama Tul Quran-7 Class-Balouchistan Edition",
	"Tadress Tarjama Tul Quran-8 Class-Balouchistan Edition",
	"Tadress Tarjama Tul Quran-9 Class-Balouchistan Edition",
	"Tadress Tarjama Tul Quran-10 Class-Balouchistan Edition",
	"Tadress Tarjama Tul Quran-11 Class-Balouchistan Edition",
	"Tadress Tarjama Tul Quran-12 Class-Balouchistan Edition",
	"MQKPUT6",
	"MQKPUT7",
	"MQKPUT8",
	"MQKPUT9",
